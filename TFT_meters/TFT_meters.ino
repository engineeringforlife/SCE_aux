...
void setup(void) {
  ...
  //consiste num data-logguer e foi desenvolvido por:
  tft.drawString("Este projecto tem o ", 0, 0, 4);
  tft.drawString("nome de \"data- ", 0, 25, 4);
  tft.drawString("-logguer CAN\" e foi", 0, 50, 4);
  tft.drawString("desenvolvido por:", 0, 75, 4);

  tft.drawString("David Drumond", 15, 100, 4);
  tft.drawString("Edgar Paulo", 15, 125, 4);
