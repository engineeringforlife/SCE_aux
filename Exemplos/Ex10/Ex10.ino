...
void setup( void )
{
  ...
  if ( xQueue != NULL )
  {
    /* Create two instances of the task that will write to the queue.  The
      ...
      priority 1. */
    xTaskCreatePinnedToCore( vSenderTask, "Sender1", 1024, ( void * ) 100, 1, NULL, 1);
    xTaskCreatePinnedToCore( vSenderTask, "Sender2", 1024, ( void * ) 200, 1, NULL, 1);

    /* Create the task that will read from the queue.  The task is created with
      priority 2, so above the priority of the sender tasks. */
    xTaskCreatePinnedToCore( vReceiverTask, "Receiver", 1024, NULL, 2, NULL, 1);
...
static void vSenderTask( void *pvParameters )
{
  ...
  for ( ;; )
  {
    ...
    if ( xStatus != pdPASS )
    {
      ...
      Serial.print( "EX10: Could not send to the queue.\r\n" );
    }
...
static void vReceiverTask( void *pvParameters )
{
  ...
  for ( ;; )
  {
    ...
    {
      Serial.print( "EX10: Queue should have been empty!\r\n" );
    }
    ...
    else
    {
      ...
      Serial.print( "EX10: Could not receive from the queue.\r\n" );
    }
  }
}
//------------------------------------------------------------------------------
