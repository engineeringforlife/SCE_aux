...
void setup( void )
{
  ...
  if( xPrintQueue != NULL )
  {
    ...
    different priorities so some pre-emption will occur. */
	  xTaskCreatePinnedToCore( prvPrintTask, "Print1", 1024, ( void * ) 0, 1, NULL, 1);
	  xTaskCreatePinnedToCore( prvPrintTask, "Print2", 1024, ( void * ) 1, 2, NULL, 1);

    /* Create the gatekeeper task.  This is the only task that is permitted
    to access standard out. */
    xTaskCreate( prvStdioGatekeeperTask, "Gatekeeper", 1024, NULL, 0, NULL );
